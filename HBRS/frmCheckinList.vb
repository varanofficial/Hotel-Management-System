...
Public Class frmCheckinList
    ...
    Private Sub lvlcheckin_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lvlcheckin.DoubleClick
        ...
        Dim dt As New DataTable("tblTransaction")
        Dim rs As SqlDataAdapter
        rs = New SqlDataAdapter("Select * from tblTransaction, tblRoom, tblDiscount WHERE tblTransaction.RoomNum = tblRoom.RoomNumber AND tblTransaction.DiscountID = tblDiscount.ID", con)
        rs.Fill(dt)
        Dim indx As Integer
        For indx = 0 To dt.Rows.Count - 1
