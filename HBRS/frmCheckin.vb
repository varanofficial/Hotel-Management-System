...
Public Class frmCheckin
    ...
    Private Sub bttnCheckIn_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnCheckIn.Click
        ...
        Else
            ...
            If a = vbYes Then
                con.Open()
                'changed SqlDataAdapter to SqlCommand
                ...
                Dim update_room As New SqlCommand("UPDATE tblRoom SET Status = 'Occupied' WHERE RoomNumber = " & txtRoomNumber.Text & "", con)
                ...
                If Val(txtSubTotal.Text) < Val(txtAdvance.Text) Or Val(txtSubTotal.Text) = Val(txtAdvance.Text) Then
                    ...
                    If change = vbYes Then
                        Dim update_trans As New SqlCommand("UPDATE tblTransaction SET AdvancePayment = " & Val(txtSubTotal.Text) & " WHERE TransID = " & trans_ID & "", con)
    ...
    Private Sub cboDiscount_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboDiscount.TextChanged
        ...
        lblAdvancePayment.Text = "Advance payment must be atleast Rs. " & (Val(txtSubTotal.Text) * 0.5).ToString("00.00")
        rs.Dispose()
        con.Close()
    End Sub
